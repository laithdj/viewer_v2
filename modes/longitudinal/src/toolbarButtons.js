  ...
  // Measurement
  {
    ...
    props: {
      ...
      items: [
        ...
        _createToolButton('Area', 'tool-angle', 'Area', undefined, {
          toolName: 'FreehandRoi',
        }),
        _createToolButton('Cobb', 'tool-angle', 'Cobb Angle', undefined, {
          toolName: 'CobbAngle',
        }),
...
//fsdf sdf sdd fsD SDF SS DSFD LK THERE IS AN EVOULO
